...
if __name__ == "__main__":
    # Define the path and expected schema for our sample file
    test_filepath = "data/raw/sample.csv"
    expected_cols = ['customer_id', 'customer_name', 'transaction_amount', 'transaction_date']
    
    print(f"Running validation on {test_filepath}...")
    final_report = generate_intake_report(test_filepath, expected_cols)
    print("Validation complete. Check output/intake_report.json for details.")